...
export const times = sqliteTable("times", {
	...
	singlePilotSingleEngine: integer("single_pilot_single_engine").notNull().default(0),
	singlePilotMultiEngine: integer("single_pilot_multi_engine").notNull().default(0),
	multiPilot: integer("multi_pilot").notNull().default(0),
	operationalConditionNight: integer(
		"operational_condition_night",
	).notNull().default(0),
	operationalConditionIfr: integer("operational_condition_ifr").notNull().default(0),
	functionPilotInCommand: integer("function_pilot_in_command").notNull().default(0),
