...
export const flightLogSchema = z.object({
	...
	singlePilotTime: durationSchema,
	multiPilotTime: durationSchema,
	operationalConditionNightTime: durationSchema,
	operationalConditionIfrTime: durationSchema,
	functionPilotInCommandTime: durationSchema,
	functionCoPilotTime: durationSchema,
	functionDualTime: durationSchema,
	functionInstructorTime: durationSchema,
	// Additional details
